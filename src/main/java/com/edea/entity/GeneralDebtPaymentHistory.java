 ...
 */
@Entity
@Table(name = "General Debt Payment History", schema = "public", catalog = "postgres")
public class GeneralDebtPaymentHistory {
    ...
    public boolean equals(Object o) {
        ...
        GeneralDebtPaymentHistory that = (GeneralDebtPaymentHistory) o;
    ...
    @Override
    public int hashCode() {
        int result = debtid != null ? debtid.hashCode() : 0;
